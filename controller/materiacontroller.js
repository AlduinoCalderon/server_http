...
const getMateria = (req, resp=response) => {resp.json({body, respuesta:true, mensaje: 'Método get consultgar una materia, realizado por Alduino' });}

const postMateria = (req, resp=response) =>  {resp.json({respuesta:true, mensaje: 'Método post para insertar materia, realizado por Alduino' });}
